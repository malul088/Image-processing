...
# ── 4. Plot ───────────────────────────────────────────────────────────────────
    ...
    #  הנקודות של אנשים ללא מחלת לב ( כחול)
    plt.scatter(x_vals[no_disease], y_vals[no_disease], color='blue', label='No Disease', alpha=0.6)

    #  הנקודות של אנשים עם מחלת לב ( אדום)
    plt.scatter(x_vals[has_disease], y_vals[has_disease], color='red', label='Has Disease', alpha=0.6)
